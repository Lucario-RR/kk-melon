...
window.__require = function e(t, n, o) {
      ...
      p = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          this.canClick && (this.moreGameBtn.off(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.canClick = !1, this.moreGameBtn.runAction(cc.sequence(cc.scaleTo(.1, 1.1), cc.scaleTo(.1, 1))), this.scheduleOnce(function () {
            window.location.href = "game.html" // Try again
          }, .15))
  ...
  HttpManagerJs: [function (e, t, n) {
    ...
    var a = e("GameConfig"),
      i = (c(o = {
        URL: "http://www.wesane.com/h5service.php/Interface/services", // Unknown service
        cacheList: null,
        isBusy: null,
        req: null,
        perform: null,
  ...
  LanguageSetJs: [function (e, t, n) {
    ...
    t.exports = {
      language_1: {
        ...
        gameT2: "\u7eb8\u724c\u63a5\u9f99",
        gameT3: "\u9526\u4e0a\u6dfb\u82b1",
        gameUrl1: "", //External link removed
        gameUrl2: "", //External link removed
        gameT11: "\u5173\u6ce8\u5fae\u4fe1",
        gameT12: "\u5173\u6ce8Kakao",
        gameT13: "\u5173\u6ce8Line",
        gameEndL: "\u6e38 \u620f \u7ed3 \u675f",
    ...
    var o = e("HttpManagerJs"),
      ...
      r = (e("GameUiTools"), {
        ...
        getHttpGameId: function () {
          ...
          this.moreGameUrl = false // Back to home page
        },
        gameOverShowText: function (e, t) {
          this.ajaxLoad("http://www.wesane.com/admin.php/Gamescore/saveGamescore", "gameScore=" + e + "&gameId=" + this.gameHttpId + "&gameType=" + t, this.scoreResult) // Fetch game score online?
        },
        gamePV_load: function () {
          this.ajaxLoad("http://www.wesane.com/admin.php/Activityshow/gamelogo", "gameID=" + this.gameHttpId, this.ajaxOnLogoResult) // Load user logo?
        },
